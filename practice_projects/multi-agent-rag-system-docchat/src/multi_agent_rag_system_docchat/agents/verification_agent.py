...
class VerificationAgent:
    def __init__(self):
        ...
        """
        logger.info("Initializing VerificationAgent with OpenAI...")
        ...
        logger.info(f"VerificationAgent initialized successfully with model: {self.model}")
    ...
    def check(self, answer: str, documents: List[Document]) -> Dict:
        ...
        # Call the OpenAI LLM to generate the verification report
        try:
            ...
            raise RuntimeError("Failed to verify answer due to an OpenAI API error.") from e
