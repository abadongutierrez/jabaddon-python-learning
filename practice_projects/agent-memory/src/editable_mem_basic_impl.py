...
# Agent doesn't have memory yet, lets add memory to the context
...
# tool description 
core_memory_save_description = "Save important information about you, the agent or the human you are chatting with."
...
agent_step("Hello")
agent_step("Next week is my birthday")
agent_step("I would like to celebrate it with my friends.")